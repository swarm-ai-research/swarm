...
> [`examples/beta/belief_shapes.ipynb`](../examples/beta/belief_shapes.ipynb) — a runnable
...
[`examples/beta/belief_shapes.ipynb`](../examples/beta/belief_shapes.ipynb).
...
`beta_swarm` is a subpackage of the [swarm](../README.md) repo — the
distributional generalization of its scalar soft-label framework. Install the
`beta` extra (it adds `scipy` for the Beta-distribution math) and run all
...
Its code lives in `beta_swarm/`, its examples in `examples/beta/`, its scenarios
in `scenarios/beta/`, and its tests in `tests/beta/`.
...
[`examples/beta/demo.py`](../examples/beta/demo.py) runs the full side-by-side:
...
[`examples/beta/belief_shapes.ipynb`](../examples/beta/belief_shapes.ipynb) (belief shapes,
...
[`examples/beta/governor_showdown.py`](../examples/beta/governor_showdown.py) runs the same
...
[`examples/beta/collusion_ring.py`](../examples/beta/collusion_ring.py) hides a three-agent
...
[`examples/beta/calibration_reliability.py`](../examples/beta/calibration_reliability.py)
...
[`examples/beta/redteam_report.py`](../examples/beta/redteam_report.py) runs three attacks
...
concentration cap** ([`examples/beta/governance_levers.py`](../examples/beta/governance_levers.py)):
...
([`examples/beta/adaptive_governance.py`](../examples/beta/adaptive_governance.py)):
...
```bash
PYTHONPATH=. python examples/beta/run_scenario.py scenarios/beta/volume_forgery_defended.yaml
```
...
tested). Three scenarios ship in [`scenarios/beta/`](../scenarios/beta): the
governor showdown, the defended forgery attack, and the adaptive retune.
